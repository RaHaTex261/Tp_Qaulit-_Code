...
/**
 * Classe représentant un formulaire d'inscription. Cette classe permet à un
 * utilisateur de s'inscrire en fournissant son prénom, nom, email et mot de
 * passe. Les données sont ensuite enregistrées dans un fichier "users.txt".
 */
public class Registration extends JFrame {
	...
	/**
	 * Constructeur qui initialise la fenêtre de l'application avec les champs et
	 * boutons nécessaires. Configure la mise en page, les champs de saisie, les
	 * boutons et les actions associées.
	 */
	public Registration() {
        ...
        footerPanel.setLayout(new BorderLayout()); // Utilisation d'un layout pour étendre le texte
        footerPanel.setBounds(0, 540, 385, 30); // Le panel du pied de page

        footerPanel.setBackground(Color.WHITE); // Fond du pied de page
        ...
        rootPanel.add(footerPanel); // Ajout du pied de page au panel principal
	}

	/**
	 * Crée un champ de texte avec un placeholder et une gestion des événements de
	 * focus.
	 * 
	...
	/**
	 * Crée un champ de mot de passe avec un placeholder et une gestion des
	 * événements de focus.
	 * 
	 * @param placeholder Le texte à afficher lorsque le champ est vide.
	 * @param x           La position horizontale du champ.
	...
	/**
	 * Méthode de gestion de l'inscription de l'utilisateur. Vérifie que tous les
	 * champs sont remplis, que l'email est valide, que le mot de passe est robuste
	 * et que les mots de passe correspondent. Enregistre les données dans un
	 * fichier "users.txt".
	 */
	...
	/**
	 * Vérifie si le mot de passe respecte les critères de robustesse : - Minimum 8
	 * caractères - Contient au moins une majuscule, un chiffre, et un caractère
	 * spécial.
	 * 
	...
	private boolean isPasswordStrong(String password) {
		return password.length() >= 8 && password.matches(".*[A-Z].*") && // Doit contenir au moins une majuscule
	...
	/**
	 * Point d'entrée de l'application. Lance le formulaire d'inscription dans une
	 * nouvelle fenêtre.
	 * 
